...
import type { MovementRecord } from "./utils/monsterMovement";
...
.control-button.primary.attention {
  border-color: rgba(255, 236, 163, 0.58);
  box-shadow:
    0 0 0 2px rgba(255, 214, 102, 0.18),
    0 12px 28px rgba(157, 82, 31, 0.28);
...
@keyframes monster-turn-pulse {
  ...
  50% {
    box-shadow:
      0 0 0 5px rgba(255, 214, 102, 0.1),
      0 16px 34px rgba(157, 82, 31, 0.34);
  }
}
